class FormGenerator{
    ...
    extraFields(fieldType){
        ...
        if (this.fieldType == 'file') {
            var field = `<input type="text" name="extensions" placeholder="e.g. jpeg,jpg,png" class="form-control" required>`;
        ...
        if (formItem.type == 'file') {
            html += `
                ...
                <div class="mt-2">
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" name="extensions" placeholder="e.g. jpeg, jpg, png" value="${formItem.extensions}" class="form-control" required="">
                        </div>
                    </div>
                </div>
            `;
